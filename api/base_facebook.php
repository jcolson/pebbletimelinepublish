...
abstract class FBAPBaseFacebook
{
  ...
  public static $DOMAIN_MAP = array(
    'api'         => XYZ_ptp_FB_api,
    'api_video'   => XYZ_ptp_FB_api_video,
    'api_read'    => XYZ_ptp_FB_api_read,
    'graph'       => XYZ_ptp_FB_graph,
    'graph_video' => XYZ_ptp_FB_graph_video,
    'www'         => XYZ_ptp_FB_www,
  );
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    $opts[CURLOPT_SSL_VERIFYPEER]=(get_option('xyz_ptp_peer_verification')=='1') ? TRUE : FALSE;
