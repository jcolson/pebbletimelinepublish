...
<div style="width: 100%">
   ...
   <a target="_blank" href="http://wordpress.org/support/view/plugin-reviews/pebble-timeline-publish" class="xyz_star">Rate this plugin</a> ★   
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input class="submit_ptp" type="submit" value="Subscribe" name="Submit"  onclick="javascript: if(!verify_fields()) return false; " />
...
Our Plugins : 
	...
	<a target="_blank"	href="http://wordpress.org/plugins/pebble-timeline-publish/">Pebble Timeline Publish</a> ★
